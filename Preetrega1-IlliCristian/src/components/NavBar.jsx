...
export default function NavBar2({ cantidad }) {
  return (
    <Disclosure
      as="nav"
      className="bg-gradient-to-tr from-red-300 to-yellow-200">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-20 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    className="block h-8 w-auto rounded-md lg:hidden"
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "font-semibold text-white hover:bg-gray-200 hover:text-white",
